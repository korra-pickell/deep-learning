...
plot_model(
    generator,
    to_file='E:\\Documents\\PRGM\\NEURAL\\3d-object-removal\\visuals\\model_gen.png',
    show_shapes=True,
...
plot_model(
    discriminator,
    to_file='E:\\Documents\\PRGM\\NEURAL\\3d-object-removal\\visuals\\model_dis.png',
    show_shapes=True,
    show_layer_names=True,
    rankdir='TB',
    dpi=64
...
def generate_images(model, test_input, tar, file_index, epoch):
    ...
    for i in range(columns*rows):
        ...
        plt.imshow(img)
        plt.axis('off')
    plt.savefig('E:\\DATA\\img_output\\3d-object-removal\\output_'+str(epoch)+'_'+str(file_index)+'.png')
    plt.close()
...
d = 'E:\\DATA\\NPY\\3d-object-removal\\'
